...
const STANDARD_FIELDS = [
  { key: 'client_name', desc: 'Parent client name' },
  { key: 'client_legal_name', desc: 'Parent client legal name' },
  { key: 'client_ein', desc: 'Parent client EIN' },
  { key: 'clinic_name', desc: 'Clinic display name' },
  { key: 'clinic_legal_name', desc: 'Clinic legal name' },
  { key: 'clinic_ein', desc: 'Clinic EIN' },
  { key: 'clinic_address', desc: 'Clinic full address' },
  { key: 'clinic_contact_name', desc: 'Clinic contact name' },
  { key: 'clinic_contact_email', desc: 'Clinic contact email' },
  ...
  { key: 'signer_name', desc: 'Client signer name (filled at sign)', special: true },
  { key: 'signer_title', desc: 'Client signer title', special: true },
  { key: 'signer_email', desc: 'Client signer email', special: true },
